  ...
  #aci
  #bgv
  #idis: x, w=-1, se=-1, bs=F, national_est
  #riikm: y, w=-1, se=-1, bs=F, rankorder=NULL, maxopt=1 (problem in calculation)
  #rci: y, w=-1, se=-1, bs=F, rankorder
  #rd: 
  #rii: y, w=-1, se=-1, bs=F, rankorder=NULL, maxopt=1
  #rr: x, se=-1, bs=F, rankorder=NULL, maxopt=1
  #sii: y, w=-1, se=-1, bs=F, rankorder=NULL, maxopt=1
  #ti: y, w=-1, se=-1, bs=F
